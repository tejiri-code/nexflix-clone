            ...
            <div className="max-w-[320px] mx-auto py-16">
              ...
              <form onSubmit={handleSubmit}>
                <input
                  ...
                  className="w-full px-4 py-2 my-4 bg-gray-800 rounded-md "
                  type="text"
                  placeholder="Email"
                  autoComplete="email"
                />
                ...
                />
                <button className="w-full px-4 py-3 my-6 bg-red-600 rounded-md font-bold">
                  Sign Up
                </button>
                ...
                <p className="py-8 text-gray-600">
                  ...
                  <a className="text-red-600 font-bold" href="/login">
                    Sign In
                  </a>
                </p>
              </form>
